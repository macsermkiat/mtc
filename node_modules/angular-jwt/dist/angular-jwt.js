...
angular.module('angular-jwt.authManager', [])
  .provider('authManager', function () {
    ...
    this.$get = ["$rootScope", "authService", "$injector", "$location", "$state" "jwtHelper", "jwtInterceptor", "jwtOptions", function ($rootScope, authService, $injector, $location, jwtHelper, jwtInterceptor, jwtOptions) {
